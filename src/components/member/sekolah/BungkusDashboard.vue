    ...
    <div class="ui stackable menu" style="margin-top:1em;">
      ...
      <div class="item">
        <router-link  to="/kelas">        
            <span class="grey-text">Pengolahan Data Absensi</span>
          </router-link>                    
      </div>
          ...
          <div class="ui card">
            ...
            <div class="content">
              <span class="date grey-text">
                Anda masuk sebagai {{$session.get('nama_lengkap')}}
              </span>              
              <!-- <a class="header">
            ...
            <!-- <div class="meta" style="padding:1em;">
              ...
              <span id="download-button" style="display:none;">
                Tombol download
              </span>
            </div>    --> 
...
<script>
    ...
    export default {
        ...
        created () {
          ...
          document.title = 'Vidyanusa Absensi | Dashboard';
        },
        data(){
          return{            
          }
